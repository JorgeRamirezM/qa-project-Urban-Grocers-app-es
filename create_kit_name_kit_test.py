...
def test5_create_kit_with_special_characters_success_response():
...
def test7_create_kit_with_string_numbers_success_response():
...
def test9_create_kit_with_numbers():
